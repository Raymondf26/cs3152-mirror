...
public class RotatingPlatformV2 extends ComplexObstacle implements GameObject {

    private BoxObstacle platform;
    private WheelObstacle pin;
    private float angle;
    Vector2 anchor;

    public RotatingPlatformV2() {
    ...
    public void storeAngle(float angle) {
        this.angle = angle;
    }
